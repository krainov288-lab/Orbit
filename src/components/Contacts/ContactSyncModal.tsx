      ...
      <div className="relative w-full max-w-md h-[540px] max-h-[85vh] rounded-3xl p-5 shadow-2xl glass-card border border-white/20 dark:border-white/10 text-primary flex flex-col">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-custom shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-primary">Управление контактами</h3>
            ...
            <div className="flex-1 min-h-0 overflow-y-auto space-y-4 no-scrollbar pr-1">
              <div className="p-4 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50/50 dark:from-slate-800/80 dark:to-slate-800/40 border border-blue-100 dark:border-slate-700">
                ...
                <div className="mt-4 flex flex-col gap-2">
                  ...
                  <button
                    onClick={() => setActiveTab('search')}
                    className="w-full py-2.5 px-4 rounded-xl bg-white dark:bg-slate-700 hover:bg-slate-50 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-xs font-semibold border border-slate-200 dark:border-slate-600 transition flex items-center justify-center gap-2 active:scale-98"
                  >
                    <Search size={14} />
                    <span>Поиск по контактам</span>
                  </button>
                </div>
              </div>
            ...
            <div className="flex-1 min-h-0 flex flex-col space-y-3">
              <div className="relative flex items-center shrink-0">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-9 py-2.5 rounded-2xl text-xs border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 outline-none focus:ring-2 focus:ring-blue-400 transition"
                />
                {searchQuery && (
                  <button
              ...
              <div className="flex-1 min-h-0 overflow-y-auto space-y-2 no-scrollbar pr-1">
                {isSearching ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-44 text-xs text-slate-400 text-center space-y-2 px-4">
                    ...
                    <span>
                      {searchQuery ? 'Пользователи не найдены' : 'Введите имя, псевдоним @username или номер телефона для глобального поиска'}
                    </span>
                  </div>
                ) : (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-blue-500 hover:bg-blue-600 active:scale-95 text-white text-[11px] font-medium transition flex items-center gap-1 shadow-xs"
                        >
                          <MessageSquare size={13} />
                          <span>Написать</span>
                        </button>
